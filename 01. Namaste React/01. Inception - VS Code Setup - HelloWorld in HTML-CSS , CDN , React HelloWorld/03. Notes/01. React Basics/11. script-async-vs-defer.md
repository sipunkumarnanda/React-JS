...
## 1️⃣ Default Behavior (No attribute)

```html
<script src="script.js"></script>
```

* ⏸️ The browser **pauses HTML parsing** to download and execute the script immediately.
...
* ⬇️ The script is fetched **asynchronously**, meaning it downloads **in parallel** while HTML parsing continues.
* ⚠️ **BUT** once downloaded, the script executes **immediately**, **pausing HTML parsing** at that moment.
...
* ⬇️ The script is fetched **in parallel** with HTML parsing, like `async`.
...
* 🏗️ Guarantees DOM is fully built before script runs.
...
## 4️⃣ Summary Table: Default vs Async vs Defer
...
## 7️⃣ Why Use These Attributes?

* 🚀 To **improve page load speed** and **user experience**.
* 🚫 Avoid render-blocking scripts.
* ⚙️ Manage script execution order and timing carefully.
